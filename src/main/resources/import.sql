...
-- aliado
INSERT INTO `aliado` (`documento`, `tipo_doc_fk`, `usuario_fk`) VALUES ('10235421346', '1', '1');
INSERT INTO `aliado` (`documento`, `tipo_doc_fk`, `usuario_fk`) VALUES ('10235421346', '2', '2');
INSERT INTO `aliado` (`documento`, `tipo_doc_fk`, `usuario_fk`) VALUES ('10235421346', '1', '3');
INSERT INTO `aliado` (`documento`, `tipo_doc_fk`, `usuario_fk`) VALUES ('10235421346', '3', '4');
-- producto
...
-- pedidoCliete
INSERT INTO `pedido_cliente` (`aliado_fk`, `pedido_fk`) VALUES ('1', '1');
INSERT INTO `pedido_cliente` (`aliado_fk`, `pedido_fk`) VALUES ('2', '2');
INSERT INTO `pedido_cliente` (`aliado_fk`, `pedido_fk`) VALUES ('3', '3');
-- paquete
INSERT INTO `paquete` (`medida`, `cantidad_inicial`, `producto_fk`) VALUES ('metros', '45', '1');
INSERT INTO `paquete` (`medida`, `cantidad_inicial`, `producto_fk`) VALUES ('centimetros', '3', '2');
INSERT INTO `paquete` (`medida`, `cantidad_inicial`, `producto_fk`) VALUES ('decametros', '4', '3'); 
-- paqueteCliente
INSERT INTO `paquete_cliente` (`pedido_cliente_fk`, `paquete_fk`) VALUES ('1', '1');
INSERT INTO `paquete_cliente` (`pedido_cliente_fk`, `paquete_fk`) VALUES ('2', '2');
INSERT INTO `paquete_cliente` (`pedido_cliente_fk`, `paquete_fk`) VALUES ('3', '3');
-- paqueteProveedor
INSERT INTO `paquete_proveedor` (`pedido_proveedor_fk`, `paquete_fk`) VALUES ('1', '1');
INSERT INTO `paquete_proveedor` (`pedido_proveedor_fk`, `paquete_fk`) VALUES ('2', '2');
INSERT INTO `paquete_proveedor` (`pedido_proveedor_fk`, `paquete_fk`) VALUES ('3', '3');
